...
<img src="@source/其他/Xcode/4/1.png" alt="Launch Screen storyboard configuration" loading="lazy"></p>
<p>storyboard，和构建视图一样：
<img src="@source/其他/Xcode/4/2.png" alt="Launch Screen storyboard" loading="lazy"></p>
...
<img src="@source/其他/Xcode/4/3.png" alt="plist配置" loading="lazy"></p>
...
<img src="@source/其他/Xcode/4/4.png" alt="多个启动屏幕的示例配置" loading="lazy">
