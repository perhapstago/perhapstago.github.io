...
<figure><img src="@source/其他/Xcode/1/xcode-breakpoint-activation-button.jpg" alt="Xcode中蓝色断点激活按钮" tabindex="0" loading="lazy"><figcaption>Xcode中蓝色断点激活按钮</figcaption></figure>
...
<img src="@source/其他/Xcode/1/move-xcode-breakpoint.png" alt="在Xcode中移动断点" loading="lazy">
移动断点后，它将显示在包含所有用户定义断点的自身部分中。
<img src="@source/其他/Xcode/1/xcode-user-breakpoints.png" alt="Xcode中用户断点的概述" loading="lazy">
...
<img src="@source/其他/Xcode/1/xcode-share-breakpoint.png" alt="在Xcode中通过GIT共享断点" loading="lazy">
这会将断点移动到具有共享断点的自己的部分。这使得获得所有共享断点的概览非常容易。
<img src="@source/其他/Xcode/1/xcode-shared-breakpoints-overview.png" alt="断点导航器中共享断点的概述" loading="lazy">
...
<img src="@source/其他/Xcode/1/objc_exception_thrown-argument-1024x529.png" alt="在抛出的异常上打印额外信息" loading="lazy">
这可以使用断点中定义的操作轻松实现自动化。任何定义的操作都将在断点被击中时执行。
<img src="@source/其他/Xcode/1/exception-breakpoints.png" alt="在异常断点中打印参数" loading="lazy">
...
<img src="@source/其他/Xcode/1/add-a-symbolic-breakpoint.png" alt="添加符号断点" loading="lazy"></p>
<p>在断点中填写关键字，每当调用该符号时，它将暂停您的应用程序以开始调试。
<img src="@source/其他/Xcode/1/UIViewAlertForUnsatisfiableConstraints-symbolic-breakpoint.png" alt="为UIViewAlertForUnsatisableConstraints添加符号断点" loading="lazy">
可以快速导航到激活不满意约束的代码。
但这不是约束错误断点吗？
...
<img src="@source/其他/Xcode/1/test-failure-breakpoints.png" alt="添加符号断点" loading="lazy"></p>
</div></template>
