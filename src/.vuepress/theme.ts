...
export default hopeTheme({
  ...
  navbarIcon: false, // 禁用导航栏图标

  logo: "/logo.svg", // 网站图标

  repoDisplay: false, // 显示Git 仓库和编辑链接
  ...
  navbarLayout: {
    start: ["Brand"],
    center: [],
    end: ["Language", "Repo", "Links", "Search", "Outlook"],
  },

  hostname: "http://yunpu.tech",
  ...
  blog: {
    ...
    medias: {
      ...
      // QQ: "http://wpa.qq.com/msgrd?v=3&uin=99765996&site=qq&menu=yes",
      // Email: "mailto:perhapsdone@163.com",
  ...
  locales: {
    ...
    "/": {
      ...
      footer: "Copyright © 2018 YUNPU All Rights Reserved",
