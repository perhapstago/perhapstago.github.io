import { ThemeFunction, App, Page, Plugin, PluginObject, PluginConfig } from '@vuepress/core';
...
declare const hopeTheme: (options: ThemeOptions, legacy?: boolean) => ThemeFunction;
...
/** @private */
declare const checkFrontmatter: (page: Page, isDebug: boolean) => void;
 ...
 */
declare const checkPlugins: (app: App, plugins: PluginsOptions) => void;
...
declare const extendsPagePlugin: (themeData: ThemeData, legacy?: boolean) => PluginObject;
declare const useExtendsPagePlugin: (app: App, themeData: ThemeData, legacy?: boolean) => void;
 ...
 */
declare const usePlugin: (app: App, themeData: ThemeData, plugins: PluginsOptions, legacy: boolean, hotReload: boolean) => void;
